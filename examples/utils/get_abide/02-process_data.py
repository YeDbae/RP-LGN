...
def main(args):
    ...
    # fea_corr = reader.get_networks(subject_IDs, iter_no='', kind='correlation', atlas_name=atlas) #(1035, 200, 200)  # changed
    # identity_matrix = np.eye(200)
    # fea_corr = np.tile(identity_matrix[np.newaxis, ...], (1035, 1, 1))
